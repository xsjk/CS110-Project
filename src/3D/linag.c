...
Vec3 mat3_transform(Vec3 a, Mat3 m) {
    return (Vec3) {{
        a.x * m.m[0][0] + a.y * m.m[0][1] + a.z * m.m[0][2],
        a.x * m.m[1][0] + a.y * m.m[1][1] + a.z * m.m[1][2],
        a.x * m.m[2][0] + a.y * m.m[2][1] + a.z * m.m[2][2]
    }};
}
...
Vec3 mat4_transform(Vec3 a, Mat4 m) {
    float w = a.x * m.m[3][0] + a.y * m.m[3][1] + a.z * m.m[3][2] + m.m[3][3];
    return (Vec3) {{
        (a.x * m.m[0][0] + a.y * m.m[0][1] + a.z * m.m[0][2] + m.m[0][3]) / w,
        (a.x * m.m[1][0] + a.y * m.m[1][1] + a.z * m.m[1][2] + m.m[1][3]) / w,
        (a.x * m.m[2][0] + a.y * m.m[2][1] + a.z * m.m[2][2] + m.m[2][3]) / w
    }};
}
